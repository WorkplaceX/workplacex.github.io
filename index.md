...
WorkplaceX is an open source framework for web applications accessing SQL databases. The framework provides APIs for data centric applications with the following functions "out of the box":
